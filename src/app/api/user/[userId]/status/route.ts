...
import { PutUserStatusFactory } from '@/modules/users/infrastructure/factories/put-user-status.factory'
...
export async function PUT(
  ...
  try {
    ...
    const putUserStatusFactory = PutUserStatusFactory.create()
    await putUserStatusFactory.execute(token, userId, user)
