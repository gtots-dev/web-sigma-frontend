...
export function MonitoringControlsScalingSlider() {
  ...
  return (
    <div className="flex flex-col items-center md:items-stretch gap-1.5">
      ...
      <input
        ...
        className="w-1 h-20 md:w-28 md:h-1 bg-muted rounded-full appearance-none [appearance:slider-vertical] md:appearance-none [writing-mode:vertical-lr] md:[writing-mode:horizontal-tb] cursor-pointer accent-primary-500 hover:accent-primary-600 transition-all
