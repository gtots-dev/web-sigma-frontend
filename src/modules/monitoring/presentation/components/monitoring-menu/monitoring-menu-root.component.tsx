...
export function MonitoringMenuRoot({ children }: MonitoringMenuRootProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col bg-card border w-[300px] relative ms-2 rounded-lg overflow-x-hidden">
