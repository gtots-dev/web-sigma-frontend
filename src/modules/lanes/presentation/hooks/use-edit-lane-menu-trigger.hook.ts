...
import { useDialog } from '../components/edit-lane-menu/edit-lane-menu-provider.component'

export function useEditLaneMenuTrigger() {
  ...
  return { loadUserEditLaneOpenDialog }
}
