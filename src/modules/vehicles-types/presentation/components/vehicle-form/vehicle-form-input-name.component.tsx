...
interface VehicleFormInputNameComponentProps {
  require?: boolean
  description?: string
}

export function VehicleFormInputNameComponent({
  require,
  description
}: VehicleFormInputNameComponentProps) {
        ...
        <FormItem>
          ...
          <FormControl>
            <Input
              ...
              placeholder="Coloque o nome do veículo"
              {...field}
            />
          </FormControl>
          <FormMessage />
