...
interface PointFormInputDescriptionComponentProps {
  require?: boolean
  description?: string
}

export function PointFormInputDescriptionComponent({
  require,
  description
}: PointFormInputDescriptionComponentProps) {
