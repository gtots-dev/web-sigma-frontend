...
interface PointFormInputNameComponentProps {
  require?: boolean
  description?: string
}

export function PointFormInputNameComponent({
  require,
  description
}: PointFormInputNameComponentProps) {
        ...
        <FormItem>
          ...
          <FormControl>
            <Input
              ...
              placeholder="Coloque o nome do ponto"
              {...field}
            />
          </FormControl>
          <FormMessage />
