...
interface ProcessingUnitsOptionsDropdownMenuComponentProps
  extends DropdownMenuContentProps {
  children: ReactNode
}

export function ProcessingUnitsOptionsDropdownMenuComponent({
  children,
  ...props
}: ProcessingUnitsOptionsDropdownMenuComponentProps) {
  return (
    <DropdownMenuContent
