...
interface TwoFactorCardRootComponentProps {
  children: ReactNode
  description: string
}

export function TwoFactorCardRootComponent({
  children,
  description
}: TwoFactorCardRootComponentProps) {
  return (
    <div className="relative flex sm:h-full min-h-svh flex-col items-center justify-center sm:justify-start bg-white sm:bg-muted dark:bg-zinc-950 sm:dark:bg-zinc-900 p-0 md:p-10">
