...
import { AddUserMenuProviderComponent } from './add-user-menu-provider.component'
import { AddUserMenuRootComponent } from './add-user-menu-root.component'
...
export const AddUserMenu = {
  ...
  Footer: AddUserMenuFooterComponent,
  Header: AddUserMenuHeaderComponent,
  Provider: AddUserMenuProviderComponent
}
